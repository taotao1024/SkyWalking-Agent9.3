...
public class HttpRequestDecoderInstrumentation extends AbstractNettyInstrumentation {
    ...
    protected ClassMatch enhanceClass() {
        return LogicalMatchOperation.or(HierarchyMatch.byHierarchyMatch("io.netty.handler.codec.http.HttpRequestDecoder")
                , MultiClassNameMatch.byMultiClassMatch("io.netty.handler.codec.http.HttpRequestDecoder"));
    }
